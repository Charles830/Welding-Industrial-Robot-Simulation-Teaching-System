# TwinWeld：基于AI大语言模型设计的焊接机器人智能孪生仿真系统

![License](https://img.shields.io/badge/license-MIT-blue.svg)
![Platform](https://img.shields.io/badge/platform-Web-orange.svg)
![Tech](https://img.shields.io/badge/tech-Three.js-green.svg)

**TwinWeld** 是一款专为中等职业学校焊接专业学生设计的轻量化工业机器人仿真平台。它利用数字孪生技术与大语言模型（LLM），在浏览器端实现了高精度的机器人示教、编程、AI辅助问答与焊接轨迹仿真，旨在解决实训设备昂贵、耗材成本高及操作风险大等现实教学痛点。

---

## 🌟 核心特性 (Key Features)

- **🤖 AI 智能助手**：内置大语言模型问答面板（支持 Google Gemini、通义千问、智谱 GLM 等），解答机械臂操作与正逆运动学算法问题。
...
1. **AI 智能助手**：点击右上角的“AI”图标，输入对应模型的 API Key，即可与 AI 助手对话，获取焊接工艺或算法指导。
2. **导入工件**：点击右侧面板的“上传模型”或使用“基本几何体”生成焊接对象。
